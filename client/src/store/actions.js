const Actions = {
    ...
    SET_IS_PARTICIPANTS_OR_CHAT : 'SET_IS_PARTICIPANTS_OR_CHAT'
  };
  ...
  export const setIsParticipantOrChat = (isParticipantOrChat) => {
    return {
      type: Actions.SET_IS_PARTICIPANTS_OR_CHAT,
      isParticipantOrChat
    }
  }
